...
RSpec.describe PageMagic::Element::Selector do
  ...
  describe PageMagic::Element::Selector::NAME do
  ...
  describe PageMagic::Element::Selector::XPATH do
    it_behaves_like 'named selector'
    it_behaves_like 'non element type selector'
  end

  describe PageMagic::Element::Selector::ID do
    it_behaves_like 'named selector'
    it_behaves_like 'non element type selector'
  end

  describe PageMagic::Element::Selector::LABEL do
    it_behaves_like 'named selector', exact: true
    it_behaves_like 'non element type selector'
  end

  describe PageMagic::Element::Selector::TEXT do
    it_behaves_like 'anonymous selector'
