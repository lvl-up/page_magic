...
RSpec.describe PageMagic::Element do
  ...
  let(:described_class) do
    Class.new(PageMagic::Element).tap { |clazz| clazz.parent_element(page) }
  end
    ...
    context 'methods created' do
      ...
      context 'Capybara element does not respond to the method' do
        it 'raises an error' do
          ...
          expect { subject.click }.to raise_error(PageMagic::NotSupportedException, expected_message)
        end
      end
    end
  end
    ...
    context 'no element definition and not a capybara method' do
      ...
      context 'method not found on parent' do
        it 'throws and exception' do
          expect { page.form_by_css.link_in_a_form.bobbins }.to raise_exception PageMagic::ElementMissingException
        end
      end
    end
  end
