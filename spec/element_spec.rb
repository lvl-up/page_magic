  ...
  describe Element do
    ...
    describe '#init' do
      ...
      it 'sets the parent element' do
        ...
        instance.init(page, :browser_element)
    ...
    describe 'hooks' do
      subject do
        ...
        instance.init(page, double('button', click: true))
        instance
      end
    ...
    describe '#respond_to?' do
      subject do
        ...
        end.new(prefetched_browser_element: double(element_method: ''))
      end
